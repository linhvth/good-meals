        ...
        <Container className="py-5 my-3">
          <Row>
            ...
            <Col xs={12} sm={12} md={8} className="align-self-center">
              <p className="plan-description">
                This plan is perfect for those who are new to healthy eating and
                want to kickstart their journey towards a healthier lifestyle.
                With a focus on whole, unprocessed foods and balanced meals,
                this plan will help you establish healthy eating habits and set
          ...
          <Row>
            <Col
              ...
              sm={12}
              md={8}
              className="align-self-center order-2 order-md-1">
              <p className="plan-description">
                This plan is designed for those who are looking for a short-term
                boost to their healthy eating habits. With a focus on
                nutrient-dense foods and quick, easy-to-prepare meals, this plan
                is perfect for busy individuals who want to eat healthily
          ...
          <Row>
            ...
            <Col xs={12} sm={12} md={8} className="align-self-center">
              <p className="plan-description">
                This plan is for those who are committed to leading a healthy
                lifestyle and want to take their nutrition to the next level.
                With a focus on performance and endurance, this plan includes
                nutrient-dense meals and snacks designed to fuel your body and
